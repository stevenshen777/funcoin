...
uint256 hashGenesisBlock("0xed45f89148dc4a4231018077f315e5d56fa0ccfcf23efc284eee944303950f0c");
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        pchMessageStart[0] = 0xf1;//fc
        pchMessageStart[1] = 0xc2;//c1
        pchMessageStart[2] = 0xb6;//b7
        pchMessageStart[3] = 0xd2;//dc
        hashGenesisBlock = uint256("0x321e9f898d24b7c5f4916565ce92e7648a55480e96c7d8fa82dd281ab9920803");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "Stock market is still down in China now 2873 points";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CBigNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 20 * COIN;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("0474c9691a71ad53fe83496e70b0262febd27b2d725d06937267c7b42c12d1abce97f10310370cd6cb051c20de076defb8b53aeec5a713f13e280da0b23fc52448") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1533019823; //1317972665; and than change this time by using date +%s
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 2086656122;//2084524493;

        if (fTestNet)
        {
            block.nTime    = 1533019720;//1317798646;first input this time by using date +%s
            block.nNonce   = 385797724;
        }

if(false && block.GetHash() != hashGenesisBlock)
	{
		printf("Searching for genesis block ... \n");
		//This will figure out a vali hash and Nonce if you're
		//creating a different geness block:
...
#if defined(_M_X64) || define(__x86_64__) || defined(_M_AMD64)||(defined(MAC_OSX) && defined(__i386__))
		//Always SSEZ:x86_64 or Intel MacOS X
	...
	printf("block.GetHash=%s \n",block.GetHash().ToString().c_str());
...
} //end of the addition part for litecoin 0.8
        ...
        assert(block.hashMerkleRoot == uint256("0x1aecf50e0a0f0181d1f575bd4f5a5ea730e371d722ed57ac0476b716e66f29a7"));//97ddfbbae6be97fd6cdf3e7ca13232a3afff2353e29badfab7f73011edd4ced9"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xfa, 0xc3, 0xba, 0xd3 }; // Funcoin: increase each by adding 2 to bitcoin's value.{ 0xfb, 0xc0, 0xb6, 0xdb }
